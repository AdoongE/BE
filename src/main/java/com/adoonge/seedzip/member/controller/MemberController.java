...
public class MemberController {
    ...
    @GetMapping
    @Operation(summary = "사용자 개인 정보 조회 API", description = "사용자 개인 정보를 조회하는 API입니다.")
    public ApiResponse<MemberInformationResponse> getMemberInformation(@AuthenticationPrincipal CustomUserDetails customUserDetails) {

        Member member = customUserDetails.getMember();

        return new ApiResponse<>(memberService.getMemberInformation(member));
    }

    @PatchMapping
    @Operation(summary = "사용자 개인 정보 수정 API", description = "사용자 개인 정보를 수정하는 API입니다.")
    ...
    @DeleteMapping
    @Operation(summary = "사용자 개인 정보 삭제(탈퇴) API", description = "사용자 개인 정보를 삭제(탈퇴)하는 API입니다.")
