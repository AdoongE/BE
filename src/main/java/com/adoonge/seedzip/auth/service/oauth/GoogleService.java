...
import com.adoonge.seedzip.auth.dto.response.oauth.google.GoogleTokenResponse;
import com.adoonge.seedzip.auth.dto.response.oauth.google.GoogleUserInfoResponse;
                            ...
                            if (response.statusCode().is2xxSuccessful()) {
                                ...
                                return response
                                        ...
                                        .flatMap(
                                                errorBody ->
                                                        Mono.error(
                                                                SeedzipException.from(ErrorCode.GET_GOOGLE_ACCESS_TOKEN_FAILED)));
                            }
                        })
    ...
    public String getLoginId(String accessToken) {
        return webClient
                ...
                .onStatus(
                        ...
                        clientResponse ->
                                Mono.error(SeedzipException.from(ErrorCode.GET_GOOGLE_UNIQUE_ID_FAILED)))
